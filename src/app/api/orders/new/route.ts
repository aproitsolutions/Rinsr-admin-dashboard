...
export async function GET(request: NextRequest) {
  try {
    ...
    // Add query params
    const upstreamUrl = new URL(`${normalizedBase}/orders/new`);
    ...
    // console.log('📦 Raw Upstream Data Keys:', Object.keys(data || {}));
    if (typeof data === 'object' && !Array.isArray(data)) {
      // console.log('📦 Non-array response sample:', JSON.stringify(data).slice(0, 200));
    }
    ...
    // Normalize the array - robust check for different response structures
